...
class AppTextStyles {
  ...
  static TextStyle get displayMedium =>
      GoogleFonts.cairo(fontSize: 32, fontWeight: FontWeight.w700, height: 1.2);

  static TextStyle get headlineLarge =>
      GoogleFonts.cairo(fontSize: 28, fontWeight: FontWeight.w700);

  static TextStyle get headlineMedium =>
      GoogleFonts.cairo(fontSize: 24, fontWeight: FontWeight.w700);
  ...
  static TextStyle get labelSmall =>
      GoogleFonts.cairo(fontSize: 10, fontWeight: FontWeight.w500);

  // للأرقام (الرصيد - المبالغ)
  static TextStyle get amountLarge =>
      GoogleFonts.cairo(fontSize: 34, fontWeight: FontWeight.w800);

  static TextStyle get amountMedium =>
      GoogleFonts.cairo(fontSize: 26, fontWeight: FontWeight.w700);
  ...
  static TextStyle get caption =>
      GoogleFonts.cairo(fontSize: 11, fontWeight: FontWeight.w400);
