...
import 'package:masrophy_app/core/theme/size/app_component_size.dart';
...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: height ?? AppComponentSize.buttonHeight,
  ...
  Widget _buildContent(Color textColor) {
    ...
    return Row(
      ...
      children: [
        if (icon != null) ...[icon!, SizedBox(width: AppIconSize.sm)],
